...
result_row = {
    "id": next_id,
    "direction around 1": bike_movement,  # Assuming the same movement applies to car 1
    "direction around 2": bike_movement,
    "average speed": round(average_speed, 2),
    "average distance 1": round(average_distance_car1, 2),
    "average distance 2": round(average_distance_car2, 2),
    "smallest distance 1": round(smallest_distance_car1, 2),
    "smallest distance 2": round(smallest_distance_car2, 2),
}
...
with open(output_file, mode='a', newline='') as file:
    file.write(
        f"{result_row['id']},{result_row['direction around 1']},{result_row['direction around 2']},"
        f"{result_row['average speed']},{result_row['average distance 1']},"
        f"{result_row['average distance 2']},{result_row['smallest distance 1']},"
        f"{result_row['smallest distance 2']}\n"
    )
